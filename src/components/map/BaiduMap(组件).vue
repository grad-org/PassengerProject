<template>
	...
	<baidu-map class="map" :center="center" :zoom="zoom" @ready="handler" @load="loadding" :scroll-wheel-zoom="true"
		...
		<bm-geolocation anchor="BMAP_ANCHOR_BOTTOM_RIGHT" :showAddressBar="false" :autoLocation="true"
			:locationIcon="{url: '../../assets/image/location.png', size: {width: '16px', height: '16px'}}" @locationSuccess="getLoctionSuccess" @locationError="getLocationError">
		</bm-geolocation>
	</baidu-map>
...
<script>
	...
	import localtionIcon from '../../assets/image/location.png'
